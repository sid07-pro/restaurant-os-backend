...
const adjust_loyalty_dto_1 = require("./dto/adjust-loyalty.dto");
...
__decorate([
    (0, common_1.Post)(':id/loyalty/add'),
    (0, roles_decorator_1.Roles)('ADMIN', 'MANAGER', 'CASHIER'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, adjust_loyalty_dto_1.AdjustLoyaltyDto]),
    __metadata("design:returntype", void 0)
], CustomersController.prototype, "addLoyaltyPoints", null);
__decorate([
    (0, common_1.Post)(':id/loyalty/deduct'),
    (0, roles_decorator_1.Roles)('ADMIN', 'MANAGER', 'CASHIER'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    ...
    __metadata("design:paramtypes", [String, adjust_loyalty_dto_1.AdjustLoyaltyDto]),
    __metadata("design:returntype", void 0)
], CustomersController.prototype, "deductLoyaltyPoints", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CustomersController.prototype, "getLoyaltyBalance", null);
__decorate([
