...
__decorate([
    ...
    (0, class_validator_1.IsNumber)({ maxDecimalPlaces: 2 }, { message: 'quantityChange must be a valid number' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'quantityChange is required' }),
