...
export declare class ReportsService {
    ...
    getPaymentMethodAnalytics(query: ReportQueryDto): Promise<{
        paymentMethod: import("@prisma/client").$Enums.PaymentMethod;
        totalAmount: number | import("@prisma/client-runtime-utils").Decimal;
        count: number;
    }[]>;
    getRefundAnalytics(query: ReportQueryDto): Promise<{
    ...
    getInventoryMovements(query: ReportQueryDto): Promise<{
    ...
    getTopVisitors(query: ReportQueryDto): Promise<{
        name: string;
        id: string;
        email: string | null;
        createdAt: Date;
    ...
    getDailyReservations(dateStr: string): Promise<({
        table: {
            name: string | null;
            id: string;
    ...
    getReservationUtilization(query: ReportQueryDto): Promise<{
    ...
    getNoShowStats(query: ReportQueryDto): Promise<{
        totalReservations: number;
        noShowCount: number;
